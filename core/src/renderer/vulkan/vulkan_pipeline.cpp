...
b8
vulkan_graphics_pipeline_create(Vulkan_Context    *context,
                                ...
                                Vulkan_Pipeline *out_pipeline)
{
    ...
    // Render double-sided geometry as requested (no back-face culling).
    rasterizer_create_info.cullMode = VK_CULL_MODE_NONE;

    // Keep mesh winding consistent with authored geometry.
...
void
vulkan_graphics_pipeline_destroy(Vulkan_Context  *context,
...
void
vulkan_graphics_pipeline_bind(Vulkan_Command_Buffer *command_buffer,
