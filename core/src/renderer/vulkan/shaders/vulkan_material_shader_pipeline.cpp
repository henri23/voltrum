...
b8
vulkan_material_shader_pipeline_create(
...
void
vulkan_material_shader_pipeline_destroy(Vulkan_Context *context,
...
void
vulkan_material_shader_pipeline_use(Vulkan_Context                  *context,
                                    Vulkan_Material_Shader_Pipeline *shader)
{
...
void
vulkan_material_shader_pipeline_set_model(
    Vulkan_Context                  *context,
    Vulkan_Material_Shader_Pipeline *shader,
    mat4                             model)
{
...
b8
vulkan_material_shader_pipeline_acquire_resource(
    Vulkan_Context                  *context,
    Vulkan_Material_Shader_Pipeline *shader,
    Material                        *material)
{
