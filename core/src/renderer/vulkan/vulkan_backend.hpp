...
// Viewport management
void  vulkan_render_viewport();
void *vulkan_get_rendered_viewport();
void  vulkan_resize_viewport(u32 width, u32 height);
void  vulkan_get_viewport_size(u32 *width, u32 *height);
