...
// Unicode ranges: 0xe000-0xe4ff (extended), 0xf000-0xf8ff (main)
// These are UTF-8 encoded Unicode codepoints

#define ICON_MIN_FA 0xe000
#define ICON_MAX_FA 0xf8ff

// File operations (FontAwesome 6 Free Solid)
...
// Navigation / Actions
#define ICON_FA_RIGHT_FROM_BRACKET "\xef\x8a\xb5"  // U+f2f5
...
#define ICON_FA_WINDOW_MAXIMIZE "\xef\x8a\x90"     // U+f2d0
#define ICON_FA_WINDOW_MINIMIZE "\xef\x8a\x91"     // U+f2d1
#define ICON_FA_WINDOW_RESTORE "\xef\x8a\x92"      // U+f2d2
...
#define ICON_FA_ROTATE_LEFT "\xef\x8a\xaa"         // U+f2ea
#define ICON_FA_ROTATE_RIGHT "\xef\x8a\xb9"        // U+f2f9
